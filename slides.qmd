...
:::{.notes}
Things to strive for. Not every project can be perfectly reproducible in every way. You still have to do your job, meet deadlines. Goal is to give you things you can implement more or less right away to level up the reproducibility of projects.
...
I used to spend some time agonizing over what deserved to be a project when I was starting something new. Now I realize that in pretty much every case where I'm wondering this, I should start a new project. More on this later, but it's better to have many well-organized, lean projects than fewer bloated projects, in my opinion. And if you start with a project structure, then begin writing your script, you're in a better position than if you start with a script and then later realize you need this to be a project.

Instead of justifying when to start a project, justify when NOT to. Make projects your default.

Now that we have the project container, we'll talk about what goes on inside.
:::
...
These both might produce the same output, but which would you rather see when you open the project and have to make sense of it (on a deadline)? This could be your own project from a year ago, or it could be a colleague's project who just had to go on emergency leave.

Reproducibility isn't just about the technical parts of an analysis. It's also about making sure that another person, who may not have your exact skill set, can walk through the analysis and understand it well enough to run it.
:::
